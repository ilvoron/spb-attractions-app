                ...
                <div className="bg-white rounded-xl shadow-sm">
                    <div className="p-6 space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <Link to="/admin/attractions/create" className="btn-primary inline-flex items-center">
                                <PlusIcon className="w-4 h-4 mr-2" /> Добавить
                            </Link>
                        </div>
                                    ...
                                    {attractionsList.map((attraction) => (
                                        <tr key={attraction.id} className="hover:bg-gray-50">
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <div className="text-sm text-gray-500">{attraction.address}</div>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <span
